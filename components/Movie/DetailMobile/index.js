    ...
    <div className="lg:hidden">
      ...
      <div className="w-full mt-20 p-5 text-white">
        ...
        <span className="text-xs te opacity-80">
          Người Nhện: Không Còn Nhà - Spider-Man: No Way Home tiếp nối câu
          chuyện ở những phần phim trước, khi giờ đây siêu anh hùng người nhện
          là Peter Parker đã bị bại lộ ra danh tính thật sự của mình cho cả thế
          giới biết, tất cả đều do Mysterio thực hiện. Giờ đây Peter phải đối
          mặt với vô số nguy hiểm không những thế còn phải bảo vệ những người
          thân của mình. Vì không thể nào chống đỡ nổi, Peter Parker đã tìm đến
          Doctor Strange xin sự trợ giúp. Nhưng mọi chuyện ngày càng đi xa và
          rắc rối hơn, giờ đây Peter phải cố gắng khám phá ra được ý nghĩa thật
          sự của bản thân khi trở thành một siêu anh hùng.
        </span>
        <div className="flex flex-col">
          ...
          <div className="flex">
            ...
            <h2 className="text-sm w-full opacity-80">
              Tom Holland, Zendaya, Benedict Cumberbatch, Jon Favreau, Jacob
              Batalon, Marisa Tomei
            </h2>
          </div>
        </div>
      </div>
