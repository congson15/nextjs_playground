...
const HeaderMiddle = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        {img.map((item, index) => (
          <div class="relative h-80 md:h-[35rem] lg:h-[45.678rem] cursor-pointer">
            <img
              src={`/img/bg${item}.png`}
              alt="background"
            ...
            <div class="absolute top-32 left-0 px-6 md:top-10 lg:top-40 lg:mx-20 grid grid-cols-2 grid-flow-col">
              <div className="col-span-10">
                ...
                <p class="block mb-9 md:mb-3 my-5 leading-normal font-normal text-gray-100">
                  <FontAwesomeIcon color="red" icon={faStar} /> 5.0 | 129 phút
                </p>
                <p class="hidden md:block font-monsterrat text-gray-50 md:mb-5 w-5/6 lg:w-2/3">
                ...
                <a
                  href="#"
                  class="bg-red-700 font-medium font-monsterrat text-white px-2 py-3.5 leading-10 tracking-widest transition duration-300 ease-in-out hover:bg-red-800 mr-6"
                >
