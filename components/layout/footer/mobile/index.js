...
const MobileNavigation = () => {
  return (
    <div className="md:hidden w-full">
      <section className="block fixed inset-x-0 bottom-0 z-10 bg-[#121212] shadow">
        <div className="flex justify-between">
          <Link href="/">
            <a className="w-full text-white focus:text-purple-500 hover:text-purple-500 justify-center inline-block text-center pt-2 pb-1">
              <svg
                width="25"
                height="25"
                viewBox="0 0 42 42"
          ...
          <Link href="/category">
            <a className="w-full text-white focus:text-purple-500 hover:text-purple-500 justify-center inline-block text-center pt-2 pb-1">
              ...
              <span className="block text-xs">Thể loại</span>
            </a>
          </Link>
        </div>
      </section>
